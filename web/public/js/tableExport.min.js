...
displayTableName:!1,escape:!1,excelstyles:[],fileName:$('#monthlySalaryStatementShow-createTime-year').val()+'年'+$('#monthlySalaryStatementShow-createTime-month').val()+'月工资表',htmlContent:!1,ignoreColumn:[],ignoreRow:[],jsonScope:"all",jspdf:{orientation:"p",unit:"pt",format:"a4",margins:{left:20,right:10,top:10,bottom:10},autotable:{styles:{cellPadding:2,rowHeight:12,fontSize:8,fillColor:255,textColor:50,fontStyle:"normal",overflow:"ellipsize",halign:"left",valign:"middle"},headerStyles:{fillColor:[52,73,94],textColor:255,fontStyle:"bold",halign:"center"},alternateRowStyles:{fillColor:245},tableExport:{onAfterAutotable:null,
onBeforeAutotable:null,onTable:null}}},numbers:{html:{decimalMark:".",thousandsSeparator:","},output:{decimalMark:".",thousandsSeparator:","}},onCellData:null,onCellHtmlData:null,outputMode:"file",tbodySelector:"tr",theadSelector:"tr",tableName:"myTableName",type:"xls",worksheetName:"xlsWorksheetName"},u=this,N=null,r=[],q=[],n=0,v=[],l="",H=[];d.extend(!0,a,t);H=P(u);if("csv"==a.type||"txt"==a.type){t=function(b,h,e,f){q=d(u).find(b).first().find(h);q.each(function(){l="";y(this,e,n,f+q.length,function(b,
